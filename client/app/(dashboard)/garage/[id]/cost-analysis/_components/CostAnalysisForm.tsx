...
type CostAnalysisInput = z.infer<typeof costAnalysisSchema>;

type Props = {
    carId: string;
};

export default function CostAnalysisForm({carId}: Props) {
            ...
            <div className="rounded-[2rem] border border-zinc-200 bg-white/75 p-6 shadow-xl backdrop-blur-xl md:p-8 dark:border-white/10 dark:bg-zinc-950/70">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            id="goal"
                            placeholder="e.g. reliable daily handling build"
                            {...register('goal')}
                        />
